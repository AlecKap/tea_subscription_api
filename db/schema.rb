...
ActiveRecord::Schema[7.0].define(version: 2023_08_01_035650) do
  # These are extensions that must be enabled in order to support this database
  enable_extension 'plpgsql'

  create_table 'customer_tea_subscriptions', force: :cascade do |t|
    t.bigint 'customer_id', null: false
    t.bigint 'tea_subscription_id', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['customer_id'], name: 'index_customer_tea_subscriptions_on_customer_id'
    t.index ['tea_subscription_id'], name: 'index_customer_tea_subscriptions_on_tea_subscription_id'
  end
  ...
  add_foreign_key 'customer_tea_subscriptions', 'tea_subscriptions'
